...
```{r slr13, message=FALSE, warning=FALSE, fig.height=8}
...
```{r slr13b, message=FALSE, warning=FALSE}
...
```{r slr13c, message=FALSE, warning=FALSE}
...
```{r slr25, message=FALSE, warning=FALSE, fig.height=8}
# generate diagnostic plots
